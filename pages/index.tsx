        ...
        <>
            ...
            <EventPage  title="Eirik Aarrestad" description="Laget av meg" background={eirikBackground}>
                <div className={styles.homePageContainer}>
                    ...
                    <div style={{ position: "absolute", top: "1250px" }} id="portefølje"></div>
                    <div id="portefølje" className={styles.infoSection}>       
                        <code className={styles.Header}>03 - PORTEFØLJE</code>
                        <PortfolioContainer portfolioValues={portfolioValues} />
                    </div>
                    <div className={styles.infoSection}>       
                        <code className={styles.Header}>Dualiteten av kunstig intelligens</code>
                        <br />
                        <b>Introduksjon</b>
                        <p>Kunstig intelligens har blitt en «game- changing» teknologi som har endret en stor del av livene våre. Denne fagartikkelen skal undersøke fordeler og ulemper med AI, og belyse det enorme potensialet, samtidig som den anerkjenner utfordringene den bringer med seg. På den ene siden gir AI bemerkelsesverdige fordeler ved å revolusjonere industrier, optimalisere prosesser og fremme vitenskapelig forskning. Imidlertid oppstår det også bekymringer angående etiske hensyn, ansvarlighet, skjevhet og potensiell forskyvning av jobb. Ved å analysere både fordeler og ulemper, kan vi bedre forstå kompleksiteten til AI og navigere ansvarlig integrasjon. Vi skal fordype dualiteten til AI, og erkjenne løftet og behovet for nøye overveielse for å utnytte fordelene samtidig som risikoen reduseres.</p>                        
                        <b>Hoveddel</b>
                        <p>Kunstig intelligens (AI) har vist seg å være en revolusjonerende teknologi med betydelige fordeler og utfordringer. På den positive siden har AI gjort en rekke fremskritt i ulike sektorer, inkludert helsevesen, transport, finans, og mer. Den har forbedret nøyaktigheten og effektiviteten i diagnostisering av sykdommer, muliggjort selvkjørende biler og optimalisert økonomiske prognoser. Disse fordelene har potensiale til å forbedre livene våre betydelig.</p>
                        <p>En av de store fordelene med AI er dens evne til å analysere enorme mengder data og avdekke mønstre og innsikter som mennesker kan gå glipp av. Dette har ført til store fremskritt innen forskning og vitenskap. AI kan analysere store datasett innen kort tid og hjelpe identifisere sammenhenger som kan hjelpe forskere med å finne nye behandlingsmetoder eller løse komplekse problemer.</p>
                        ...
                        <p>En viktig utfordring knyttet til AI er også skjevhet i dataene som brukes til å trene algoritmene. Hvis dataene er partiske eller ikke representerer mangfoldet i samfunnet, kan det føre til skjeve resultater og urettferdige beslutninger. Dette kan skape negative konsekvenser for ulike grupper i samfunnet og forsterke eksisterende ulikheter.</p>
                        ...
                        <b>Konklusjon</b>
                        <p>Kunstig intelligens har vist seg å være en revolusjonerende teknologi med betydelige fordeler og potensielle utfordringer. Gjennom denne artikkelen har vi sett hvordan AI har revolusjonert ulike sektorer og bidratt til økt nøyaktighet, effektivitet og innovasjon. AI har muliggjort store fremskritt innen helsevesen, transport, økonomi og vitenskap ved å analysere store datasett og avdekke innsikter som mennesker kan gå glipp av. Samtidig er det viktig å være oppmerksom på bekymringene knyttet til etikk, ansvarlighet, arbeidsledighet og skjevhet i dataene. For å utnytte potensialet til AI på en ansvarlig måte, er det nødvendig med nøye overveielse og regulering. Det krever investeringer i forskning og utvikling av transparente og ikke-diskriminerende algoritmer, samt utvikling av etiske retningslinjer for rettferdig bruk av AI. Ved å balansere fordeler og ulemper, kan vi navigere kompleksiteten til kunstig intelligens og arbeide mot en fremtid der vi maksimerer fordelene samtidig som vi reduserer risikoen og sikrer et rettferdig og inkluderende samfunn.</p>
                        <br />
                        <b>kilder</b>
                        <p>(Stanford University, 2021)</p>
                        <p>(Built in, 2023)</p>
                        <p>(Store Norske Leksikon, 2023)</p>
                        <p>(Regjeringen, 2023)</p>
                    </div>
                </div>
            </EventPage>
        </>
